          ...
          <div className="mt-3 flex gap-2">
            {step > 0 && (
              <button
                ...
                className="inline-flex min-h-11 flex-none cursor-pointer items-center rounded-[14px] border border-tm-onink px-4 text-[14px] text-white transition-transform duration-150 active:scale-[0.98]"
              >
                Back
              </button>
            )}
